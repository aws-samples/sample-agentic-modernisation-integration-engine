...
> **⚠️ NOTE: This codebase was generated by the [Kiro](https://kiro.dev) agent from a Kiro spec.**
> The application code, configuration, and tests in this repository were produced by the Kiro AI
> agent, driven by the specification under `.kiro/specs/` (requirements, design, and tasks).
>
> It is published **for reference only** — not as a curated example, a best-practice template, or a
> demonstration of a recommended workflow. It is raw AI-generated output that has not been hardened
> or reviewed for production use. See the [Disclaimer](#disclaimer) for usage limitations before
> relying on any part of it.
